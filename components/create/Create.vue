  ...
  <div class="create-section">
    ...
    <div class="create-box">
      ...
      <div class="metadata-form">
        <input v-model="metadata" class="meta-input" :class="{'resError': isError }" placeholder="Enter or replace the meta URI" @change="metaChange()"></input>
      ...
      <div class="create-action">
        ...
        <button class="save" @click="create()">
          Create
        </button>
        <button @click="goBack()">
          Go to home
...
export default {
  ...
  mounted () {
    if (this.account === '0x1EF3e6400e4dD35238377b33BBF7BFc589BdefFA') {
      this.isActive = true
